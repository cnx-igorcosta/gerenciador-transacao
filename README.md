# gerenciador-transacao
Desenvolvido para o [Desafio B2W](https://github.com/admatic-tool/vaga-b2wads-senior), consiste em 4 microsserviços Docker para gerenciamento de transações multi-passos. Foram criados utilizando NodeJs com framework Express, ES6, MongoDb, Rabbitmq e orquestrados via Docker Compose.
